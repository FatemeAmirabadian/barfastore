  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-2 px-3">
        <Link
          href={"/blogs"}
          className="inline-flex px-2 py-1 sm:px-6 sm:py-2 rounded-3xl text-white bg-blue-500 hover:bg-blue-700 border-2 border-blue-600 shadow-md hover:shadow-xl transition-all duration-200"
        >
          مشاهده همه
        </Link>
